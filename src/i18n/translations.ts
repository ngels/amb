...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'identification.step1.picturePreviewAlt': 'Profile picture preview',
    'identification.step1.pictureFormatError': 'Only JPG and PNG images are allowed.',
    'identification.step1.pictureSizeError': 'Image must be 250 KB or smaller.',
    'identification.step1.pictureUploading': 'Uploading...',
    'identification.step1.pictureSavedPath': 'Saved file path',
    ...
    'identification.step2.noTerritories': 'No territories available for this province',
  ...
  fr: {
    ...
    'identification.step1.picturePreviewAlt': 'Aperçu de la photo de profil',
    'identification.step1.pictureFormatError': 'Seules les images JPG et PNG sont autorisées.',
    'identification.step1.pictureSizeError': 'L\'image doit peser 250 Ko ou moins.',
    'identification.step1.pictureUploading': 'Téléversement en cours...',
    'identification.step1.pictureSavedPath': 'Chemin du fichier enregistré',
    ...
    'identification.step2.noTerritories': 'Aucun territoire disponible pour cette province',
